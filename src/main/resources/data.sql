/*INSERT INTO car(daily_cost, brand, model, plate_number)
VALUES ('500', 'Volvo', 'V60', 'ABC123');
INSERT INTO car(daily_cost, brand, model, plate_number)
VALUES ('500', 'Volkswagen', 'Golf', 'DEF456');
INSERT INTO car(daily_cost, brand, model, plate_number)
VALUES ('500', 'Toyota', 'Corolla', 'GHI789');
INSERT INTO car(daily_cost, brand, model, plate_number)
VALUES ('500', 'Ford', 'Focus', 'JKL012');
INSERT INTO car(daily_cost, brand, model, plate_number)
VALUES ('500', 'Audi', 'A4', 'MNO345');*/
...
VALUES ('user5678', 'Emma Johnson', '123 Oak Street, Springfield, 98765', 'emma.johnson@email.com', '555-123-4567'),
       ('coolguy91', 'Maxwell Rodriguez', '456 Maple Avenue, Rivertown, 54321', 'max.rodriguez@email.com',
        '555-987-6543'),
